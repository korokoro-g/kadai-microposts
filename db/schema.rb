...
ActiveRecord::Schema.define(version: 2019_08_19_011244) do
  ...
  create_table "favos", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["micropost_id"], name: "index_favos_on_micropost_id"
    t.index ["user_id", "micropost_id"], name: "index_favos_on_user_id_and_micropost_id", unique: true
